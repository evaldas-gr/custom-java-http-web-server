...
import static org.webserver.http.data.headers.HttpContentTypes.APPLICATION_TEXT_JAVASCRIPT;
import static org.webserver.http.data.headers.HttpHeaders.CONTENT_TYPE;

public class JavascriptHandler extends HttpHandler {

    private final Resource resource;
    private static final Map<String, String> headers = new HashMap<>(Map.of(CONTENT_TYPE.getValue(), APPLICATION_TEXT_JAVASCRIPT.getValue()));

    public JavascriptHandler(String path, Resource resource) {
